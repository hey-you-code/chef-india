...
const RegularBookingScreen = ({navigation}) => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white rounded-t-3xl">
      ...
      {/* {currentPage === 1 ? <Menu actionApplicable={true} menuType={"regular"} country={"India"} /> : undefined} */}
...
export default RegularBookingScreen;
